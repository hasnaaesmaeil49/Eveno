...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> signInWithGoogle() async {
    try {
      ...
      Navigator.of(context).pushReplacementNamed(AppRouting.routeHome);
    } catch (e) {
          ...
          child: Column(
            ...
            children: [
                ...
                textStyle: AppStyle.white20Medium,
                  onClickedButton: () async {
                    ...
                    if (email.isEmpty || password.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('من فضلك ادخل البريد وكلمة المرور')),
                      );
                      return;
                    }
                    ...
                    try {
                      ...
                      // لو التسجيل تم بنجاح → نروح على الهوم سكرين
                      Navigator.of(context).pushAndRemoveUntil(
                        MaterialPageRoute(builder: (context) => const HomeScreen()),
                            (route) => false,
                      );
                    } on FirebaseAuthException catch (e) {
                      // لو حصلت مشكلة نعرض رسالة مفهومة للمستخدم
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                       ...
                       ScaffoldMessenger.of(context).showSnackBar(
                         const SnackBar(content: Text('حدث خطأ غير متوقع. برجاء المحاولة لاحقًا.')),
                       );
                    }
                  }
              ),
              ...
              CustomElevatedButton(
                ...
                textStyle: AppStyle.white20Medium,
                onClickedButton: signInWithGoogle,
              ),
              SizedBox(height: height * 0.02),
              InkWell(
                onTap: () => Navigator.of(context).pushReplacementNamed(AppRouting.routeRegister),
                child: Text.rich(
              ...
              SizedBox(height: height * 0.02),
              InkWell(
                onTap: () => Navigator.of(context).pushNamed(AppRouting.routeForgetPassword),
                child: Center(
                  child: Text(
